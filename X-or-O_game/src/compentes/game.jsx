...
const Game = () => {
  return (
    <div className='w-[99%] h-[99%] flex justify-start items-start bg-transparent p-2.5'>
        <div className='w-75 h-100 flex flex-row justify-center items-center bg-indigo-200 ring-2 ring-indigo-700 rounded-lg shadow-2xs shadow-indigo-700 p-2.5 gap-1'>
